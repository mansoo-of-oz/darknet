...
void run_compare(int argc, char **argv)
{
    ...
    if(0==strcmp(argv[2], (char *)"train")) train_compare(cfg, weights);
    else if(0==strcmp(argv[2], (char *)"valid")) validate_compare(cfg, weights);
    else if(0==strcmp(argv[2], (char *)"sort")) SortMaster3000(cfg, weights);
    else if(0==strcmp(argv[2], (char *)"battle")) BattleRoyaleWithCheese(cfg, weights);
    /*
       else if(0==strcmp(argv[2], (char *)"train")) train_coco(cfg, weights);
       else if(0==strcmp(argv[2], (char *)"extract")) extract_boxes(cfg, weights);
       else if(0==strcmp(argv[2], (char *)"valid")) validate_recall(cfg, weights);
     */
}
