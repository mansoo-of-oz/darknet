...
void train_dcgan(char *cfg, char *weight, char *acfg, char *aweight, int clear, int display, char *train_images, int maxbatch)
{
    ...
    int i, j, k;
    layer imlayer;
    memset(&imlayer, 0x00, sizeof(layer));
...
void run_lsd(int argc, char **argv)
{
    ...
    //if(0==strcmp(argv[2], (char *)"train")) train_lsd(cfg, weights, clear);
    //else if(0==strcmp(argv[2], (char *)"train2")) train_lsd2(cfg, weights, acfg, aweights, clear);
    //else if(0==strcmp(argv[2], (char *)"traincolor")) train_colorizer(cfg, weights, acfg, aweights, clear);
    //else if(0==strcmp(argv[2], (char *)"train3")) train_lsd3(argv[3], argv[4], argv[5], argv[6], argv[7], argv[8], clear);
    if(0==strcmp(argv[2], (char *)"traingan")) train_dcgan(cfg, weights, acfg, aweights, clear, display, file, batches);
    else if(0==strcmp(argv[2], (char *)"trainprog")) train_prog(cfg, weights, acfg, aweights, clear, display, file, batches);
    else if(0==strcmp(argv[2], (char *)"traincolor")) train_colorizer(cfg, weights, acfg, aweights, clear, display);
    else if(0==strcmp(argv[2], (char *)"gan")) test_dcgan(cfg, weights);
    else if(0==strcmp(argv[2], (char *)"inter")) inter_dcgan(cfg, weights);
    else if(0==strcmp(argv[2], (char *)"test")) test_lsd(cfg, weights, filename, 0);
    else if(0==strcmp(argv[2], (char *)"color")) test_lsd(cfg, weights, filename, 1);
    /*
       else if(0==strcmp(argv[2], (char *)"valid")) validate_lsd(cfg, weights);
     */
}
