...
{
    char *train_images = (char *)"/data/voc/train.txt";
...
void run_yolo(int argc, char **argv)
{
    ...
    if(0==strcmp(argv[2], (char *)"test")) test_yolo(cfg, weights, filename, thresh);
    else if(0==strcmp(argv[2], (char *)"train")) train_yolo(cfg, weights);
    else if(0==strcmp(argv[2], (char *)"valid")) validate_yolo(cfg, weights);
    else if(0==strcmp(argv[2], (char *)"recall")) validate_yolo_recall(cfg, weights);
    else if(0==strcmp(argv[2], (char *)"demo")) demo(cfg, weights, thresh, cam_index, filename, voc_names, 20, frame_skip, prefix, avg, .5, 0,0,0,0);
}
