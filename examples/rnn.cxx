...
char **read_tokens(char *filename, size_t *read)
{
    ...
    while((line=fgetl(fp)) != 0){
        ...
        if(0==strcmp(line, "<NEWLINE>")) line = (char *)"\n";
        d[count-1] = line;
    }
    fclose(fp);
...
void run_char_rnn(int argc, char **argv)
{
    ...
    if(0==strcmp(argv[2], (char *)"train")) train_char_rnn(cfg, weights, filename, clear, tokenized);
    else if(0==strcmp(argv[2], (char *)"valid")) valid_char_rnn(cfg, weights, seed);
    else if(0==strcmp(argv[2], (char *)"validtactic")) valid_tactic_rnn(cfg, weights, seed);
    else if(0==strcmp(argv[2], (char *)"vec")) vec_char_rnn(cfg, weights, seed);
    else if(0==strcmp(argv[2], (char *)"generate")) test_char_rnn(cfg, weights, len, seed, temp, rseed, tokens);
    else if(0==strcmp(argv[2], (char *)"generatetactic")) test_tactic_rnn(cfg, weights, len, temp, rseed, tokens);
}
