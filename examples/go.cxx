...
void run_go(int argc, char **argv)
{
    ...
    if(0==strcmp(argv[2], (char *)"train")) train_go(cfg, weights, c2, gpus, ngpus, clear);
    else if(0==strcmp(argv[2], (char *)"valid")) valid_go(cfg, weights, multi, c2);
    else if(0==strcmp(argv[2], (char *)"self")) self_go(cfg, weights, c2, w2, multi);
    else if(0==strcmp(argv[2], (char *)"test")) test_go(cfg, weights, multi);
    else if(0==strcmp(argv[2], (char *)"engine")) engine_go(cfg, weights, iters, time, temp, cpuct, anon, resign);
}
