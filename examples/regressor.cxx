...
void run_regressor(int argc, char **argv)
{
    ...
    if(0==strcmp(argv[2], (char *)"test")) predict_regressor(data, cfg, weights);
    else if(0==strcmp(argv[2], (char *)"train")) train_regressor(data, cfg, weights, gpus, ngpus, clear);
    else if(0==strcmp(argv[2], (char *)"demo")) demo_regressor(data, cfg, weights, cam_index, filename);
}
