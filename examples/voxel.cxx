...
void run_voxel(int argc, char **argv)
{
    ...
    if(0==strcmp(argv[2], (char *)"train")) train_voxel(cfg, weights);
    else if(0==strcmp(argv[2], (char *)"test")) test_voxel(cfg, weights, filename);
    else if(0==strcmp(argv[2], (char *)"extract")) extract_voxel(argv[3], argv[4], argv[5]);
    /*
       else if(0==strcmp(argv[2], (char *)"valid")) validate_voxel(cfg, weights);
     */
}
