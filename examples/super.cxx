...
void run_super(int argc, char **argv)
{
    ...
    if(0==strcmp(argv[2], (char *)"train")) train_super(cfg, weights, clear);
    else if(0==strcmp(argv[2], (char *)"test")) test_super(cfg, weights, filename);
    /*
    else if(0==strcmp(argv[2], (char *)"valid")) validate_super(cfg, weights);
    */
}
