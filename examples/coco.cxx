...
void run_coco(int argc, char **argv)
{
    ...
    if(0==strcmp(argv[2], (char *)"test")) test_coco(cfg, weights, filename, thresh);
    else if(0==strcmp(argv[2], (char *)"train")) train_coco(cfg, weights);
    else if(0==strcmp(argv[2], (char *)"valid")) validate_coco(cfg, weights);
    else if(0==strcmp(argv[2], (char *)"recall")) validate_coco_recall(cfg, weights);
    else if(0==strcmp(argv[2], (char *)"demo")) demo(cfg, weights, thresh, cam_index, filename, coco_classes, 80, frame_skip, prefix, avg, .5, 0,0,0,0);
}
