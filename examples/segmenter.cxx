...
void run_segmenter(int argc, char **argv)
{
    ...
    if(0==strcmp(argv[2], (char *)"test")) predict_segmenter(data, cfg, weights, filename);
    else if(0==strcmp(argv[2], (char *)"train")) train_segmenter(data, cfg, weights, gpus, ngpus, clear, display);
    else if(0==strcmp(argv[2], (char *)"demo")) demo_segmenter(data, cfg, weights, cam_index, filename);
}
